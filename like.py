    ...
    try:
        ...
        for feed_post in feed:
            ...
            if uri and cid:
                ...
                print(f"\nLiked post with URI: {uri} and CID: {cid}")  # Print confirmation message
            else:
                print("\nSkipping post with missing URI or CID.")  # Skip posts that are missing required data
    except Exception as e:
        print("\nAn error occurred while liking posts:", e)  # Catch any exceptions and print an error message
