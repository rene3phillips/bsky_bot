...
# Schedule tasks
schedule.every().day.at("14:10").do(post_text_with_log)  
schedule.every().day.at("14:11").do(post_image_with_log)  
schedule.every().day.at("14:12").do(like_posts_with_log) 
schedule.every().day.at("14:13").do(follow_with_log)  
